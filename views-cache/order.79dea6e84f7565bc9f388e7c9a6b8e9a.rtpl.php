...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            Para
            <address>
                <strong><?php echo htmlspecialchars( $order["nome"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <?php echo htmlspecialchars( $order["sobrenome"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong><br>
                ...
                <?php if( $order["tel"] && $order["tel"]!='0' ){ ?>Telefone: <?php echo htmlspecialchars( $order["tel"], ENT_COMPAT, 'UTF-8', FALSE ); ?><br><?php } ?>
                E-mail: <?php echo htmlspecialchars( $order["email"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
