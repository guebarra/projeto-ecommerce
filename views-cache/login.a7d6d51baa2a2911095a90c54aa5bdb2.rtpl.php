        ...
        <div class="row">                
            ...
            <div class="col-md-6">
                ...
                <form id="register-form-wrap" action="/register" class="register" method="post">
                    ...
                    <p class="form-row form-row-first">
                        <label for="sobrenome">Sobrenome <span class="required">*</span>
                        </label>
                        <input type="text" id="sobrenome" name="lastname" class="input-text" value="<?php echo htmlspecialchars( $registerValues["lastname"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-first">
                        <label for="cpf">CPF <span class="required">*</span>
                        </label>
                        <input type="text" id="cpf" name="cpf" class="input-text" value="<?php echo htmlspecialchars( $registerValues["cpf"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-first">
